      ...
      if mode != 'SAME_RESNET':
        ...
        if d_height == 1 and d_width == 1:
          ...
          conv = self._conv2d_impl(input_layer, num_channels_in,
                                   ...
                                   kernel_initializer=kernel_initializer)
          padding_gleb=padding[2]
      if use_batch_norm is None:
        use_batch_norm = self.use_batch_norm
      print(name, "\n   Hight/weight: ", input_layer.get_shape()[2], input_layer.get_shape()[3], "\n   Batch size: ",input_layer.get_shape()[0],"\n   Chanels in: ",
            num_channels_in, "\n   Chanels out: ", num_out_channels, "\n   Kernal width/height: ", k_width, "/",
            k_height, "\n   Stride: ", strides, "\n   Padding: ", padding_gleb)
